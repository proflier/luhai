...
<div id="tb" style="padding:5px;height:auto">
	<form id="searchFrom" action="">
	    <input type="text" name="filter_LIKES_serialNumber_OR_serialTitle" class="easyui-validatebox" data-options="width:150,prompt: '请输入流水号'"/>
...
$(function(){   
	dg=$('#dg').datagrid({  
	    ...
	    columns:[[    
			...
			{field:'serialTitle',title:'水单抬头',sortable:true,width:20,
				...
				formatter: function(value,row,index){
					...
					if(value!=''&&value!=null){
						$.ajax({
							type:'GET',
							async: false,
							url:"${ctx}/system/downMenu/getDictName/fundCategory/"+value,
							success: function(data){
								if(data != null){
									val = data;
								} else {
