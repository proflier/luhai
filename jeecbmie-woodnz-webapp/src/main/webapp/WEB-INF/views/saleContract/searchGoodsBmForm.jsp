...
<div>
	...
	<table width="98%" class="tableClass">
		<tr>
			...
			<td>
			<input type="text" id="goodsType" name=goodsType value="${code.type}"/>
			</td>
			<th><font style="vertical-align:middle;color:red" ></font>材种</th>
			<td><input type="text" id="species" name="species" value="${code.species}"/></td>
		</tr>
		<tr>
			<th><font style="vertical-align:middle;color:red" ></font>等级</th>
			<td><input name="classes" id="classes" type="text" value="${code.classes}"/></td>
		
			<th><font style="vertical-align:middle;color:red" ></font>宽厚</th>
			<td><input name="spec" type="text" id="spec" value="${code.spec}"/></td>
		</tr>
		<tr>
			<th><font style="vertical-align:middle;color:red" ></font>长度</th>
			<td><input name="length" id="length" type="text" value="${code.length}" />
			</td>
			<th><font style="vertical-align:middle;color:red" ></font>品牌</th>
			<td><input name="brand" id="brand" type="text" value="${code.brand}" />
			</td>	
		</tr>
		<tr>
			<th colspan="4">
		...
		<tr>
			...
			<td><input name="goodsNo" id="goodsNo"  class="easyui-textbox" value="${code.goodsNo}" />
			</td>
			<th><font style="vertical-align:middle;color:red" ></font>商品名称</th>
			<td><input name="goodsName" id="goodsName" type="text" class="easyui-textbox" value="${code.goodsName}" />
			</td>
		</tr>	
