...
import com.cbmie.woodNZ.credit.service.MortgageRegService;
...
public class MortgageRegController extends BaseController {
	...
	public String createForm(Model model) {
		model.addAttribute("mortgageReg", new MortgageReg());
	...
	@ResponseBody
	public String update(@Valid @ModelAttribute @RequestBody MortgageReg mortgageReg, Model model) throws JsonProcessingException {
		User currentUser = UserUtil.getCurrentUser();
