...
import com.cbmie.woodNZ.credit.service.PayMortgageRegService;
...
public class PayMortgageRegController extends BaseController {
	...
	public String createForm(Model model) {
		model.addAttribute("payMortgageReg", new PayMortgageReg());
	...
	@ResponseBody
	public String update(@Valid @ModelAttribute @RequestBody PayMortgageReg payMortgageReg, Model model) throws JsonProcessingException {
		User currentUser = UserUtil.getCurrentUser();
