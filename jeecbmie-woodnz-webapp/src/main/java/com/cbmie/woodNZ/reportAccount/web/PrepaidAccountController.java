...
import com.cbmie.woodNZ.reportAccount.service.PrepaidAccountService; 

@Controller
@RequestMapping("account/prepaidAccount")
public class PrepaidAccountController {
	
	/** 日志实例 */
	private static final Logger logger = Logger.getLogger(PrepaidAccountController.class);
	
	@Autowired
	protected PrepaidAccountService prepaidAccountService;
	...
	public String html() {
		return "account/prepaidAccount";
	}
	
	@RequestMapping(value = "data", method = RequestMethod.GET)
	@ResponseBody
	public Map<String, Object> data(HttpServletRequest request) {
		return prepaidAccountService.search(showParams(request));
