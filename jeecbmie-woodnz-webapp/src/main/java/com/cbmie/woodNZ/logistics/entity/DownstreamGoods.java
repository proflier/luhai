 ...
 */
@Entity
@Table(name = "WOOD_DOWNSTREAM_GOODS")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@DynamicUpdate
@DynamicInsert
public class DownstreamGoods  extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	
	/** 采购合同号 **/
	private String cghth;
	/** 销售合同号 **/
	...
	@Column(name = "CG_HTH")
	public String getCghth() {
		return cghth;
	}

	public void setCghth(String cghth) {
		this.cghth = cghth;
	}
	@Column(name = "SL")
	public String getSl() {
