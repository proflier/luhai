...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	 ...
	 * @return
	 */
	public static String formatDistanceTimes(String str1, String str2) {
		String dataFormatStr = "";
		try {
			long[] times = getDistanceTimes(str1, str2);
			dataFormatStr = (times[0] == 0 ? "" : times[0] + "天") + 
					(times[1] == 0 ? "" : times[1] + "小时") + 
					(times[2] == 0 ? "" : times[2] + "分") + 
					(times[3] == 0 ? "" : times[3] + "秒");
		} catch (ParseException e) {
			e.printStackTrace();
	 ...
	 * @return
	 */
	public static String formatDistanceTimesInSecond(String str1, String str2) {
		String dataFormatStr = "";
		try {
			long[] times = getDistanceTimes(str1, str2);
			dataFormatStr = (times[0] == 0 ? "" : times[0] + "天") + 
