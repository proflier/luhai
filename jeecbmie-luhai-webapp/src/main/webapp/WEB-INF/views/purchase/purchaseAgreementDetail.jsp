...
<script type="text/javascript"> 
	...
	$.ajax({
		url : '${ctx}/baseInfo/baseUtil/affiBaseInfoNameByCode/${purchaseAgreement.customer }',
		type : 'get',
		cache : false,
		success : function(data) {
			$('#customer').text(data);
	...
	$.ajax({
		url : '${ctx}/baseInfo/baseUtil/affiBaseInfoNameByCode/${purchaseAgreement.thirdParty }',
		type : 'get',
		cache : false,
		success : function(data) {
	...
	$.ajax({
		url : '${ctx}/baseInfo/baseUtil/affiBaseInfoNameByCode/${purchaseAgreement.company }',
		type : 'get',
		cache : false,
		success : function(data) {
			$('#company').text(data);
	...
	$.ajax({
		url : '${ctx}/baseInfo/baseUtil/affiBaseInfoNameByCode/${purchaseAgreement.ourUnit }',
		type : 'get',
		cache : false,
		success : function(data) {
			$('#ourUnit').text(data);
	...
	$.ajax({
		type:'get',
		url:'${ctx}/baseInfo/baseUtil/countryAreaNameShow/${purchaseAgreement.addr}',
		success:function(data){
			if(data!=null){
				$('#addr').text(data);
			}
