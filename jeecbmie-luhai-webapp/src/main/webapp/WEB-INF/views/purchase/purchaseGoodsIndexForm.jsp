<%@page import="com.cbmie.lh.purchase.entity.PurchaseGoodsIndex"%>
<%@page import="com.cbmie.lh.purchase.entity.PurchaseContractGoods"%>
...
<%
	PurchaseContractGoods purchaseContractGoods = (PurchaseContractGoods)request.getAttribute("purchaseContractGoods");
	...
	String childJson = objectMapperCus.writeValueAsString(purchaseGoodsIndexList);
