            ...
            <div id="toolbar" class="panel-header panel-header-noborder top-toolbar">
                ...
                <div id="buttonbar">
                    ...
                    <div id="layout_north_set">
                    	<div id="chgPwd" onclick="add();" data-options="iconCls:'icon-standard-lock-edit'">修改密码</div>
                    	<div onclick="toUpdateCurrent();" data-options="iconCls:'icon-standard-user-edit'">修改资料</div>
...
$.ajax({
	...
	//修改资料
	function toUpdateCurrent() {
		d = $("#dlg").dialog({
			title : '修改资料',
			width: 400,    
		    height: 360,   
			href : '${ctx}/system/user/toUpdateCurrent',
			maximizable : true,
			modal : true,
			buttons : [ {
				text : '保存',
