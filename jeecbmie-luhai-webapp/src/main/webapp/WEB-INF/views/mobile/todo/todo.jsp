...
<html id="todoWindow">
	<head>
		...
		<script type="text/javascript">
			...
			function doTask() {
				...
				var method = "POST";
				//设置发送数据
				var data = "taskId=${approval.taskId}&businessKey=${approval.businessKey}&key=${approval.key}&processInstanceId=${approval.processInstanceId}&loginName=${loginName}";
				//设置自定义http头 json格式
				var requestHeader = {};
				//设置进度条显示
	...
	<footer>
		...
		<input type="button" value="审批" style="align: center;width: 40%;" onclick="doTask()"/>
	</footer>
</html>