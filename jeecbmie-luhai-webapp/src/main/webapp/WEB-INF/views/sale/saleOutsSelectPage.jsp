...
<script type="text/javascript">
	...
	method: "get",
	url:'${ctx}/sale/settlementOutRel/getOutsSelectItem/${saleContractNo}/${settlementId}', 
    fit : false,
    singleSelect:false,
	fitColumns : true,
	border : false,
	...
	striped:true,
	 columns:[[    
				...
				{field:'goodsNo',title:'品名',width:20,
					formatter: function(value,row,index){
						var val;
						if(value!=''&&value!=null){
							$.ajax({
				...
				{field:'quantity',title:'数量',width:20},
				{field:'transType',title:'运输方式',width:20,
					formatter: function(value,row,index){
						var val;
						if(value!=''&&value!=null){
							$.ajax({
