<%@page import="com.cbmie.lh.sale.entity.SaleOfferGoods"%>
<%@page import="com.cbmie.lh.sale.entity.SaleOfferIndex"%>
...
<%
	SaleOfferGoods goods = (SaleOfferGoods)request.getAttribute("saleOfferGoods");
	List<SaleOfferIndex> indexList = goods.getIndexList();
...
$(function(){
    ...
    columns:[[    
		...
		{field:'indexName',title:'指标名称（中文）',width:20,
     		editor:{
				type:'combobox',
				options:{
		...
		{field:'indexNameEn',title:'指标名称（英文）',width:20,editor:{type:'validatebox',options:{disabled:true}}},
     	...
     	{field:'description',title:'价格调整说明',width:25,editor:{type:'validatebox'}},
    ]],
