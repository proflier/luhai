...
import com.cbmie.lh.purchase.service.ProflitLossAccountingService;
...
public class ProflitLossAccountingController extends BaseController {
	...
	public String list() {
		return "purchase/proflitLossList";
	}
	...
	public String createForm(Model model) {
		ProflitLossAccounting proflitLossAccounting = new ProflitLossAccounting();
		proflitLossAccounting.setCreateDate(new Date());
		proflitLossAccounting.setUpdateDate(new Date());
		model.addAttribute("proflitLossAccounting", proflitLossAccounting);
		model.addAttribute("action", "create");
		return "purchase/proflitLossForm";
	}
	...
	public String detail(@PathVariable("id") Long id, Model model) {
		model.addAttribute("proflitLossAccounting", proflitLossAccountingService.get(id));
		return "purchase/proflitLossDetail";
	}
