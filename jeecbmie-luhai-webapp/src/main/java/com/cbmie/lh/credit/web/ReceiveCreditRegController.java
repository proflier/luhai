...
import com.cbmie.lh.credit.service.ReceiveCreditRegService;
...
public class ReceiveCreditRegController extends BaseController {
	...
	public Map<String, Object> getList(HttpServletRequest request) {
		...
		receiveCreditRegService.setCurrentPermission(filters, "LIKES_relLoginNames_OR_createrNo");
	...
	public String createForm(Model model) {
		ReceiveCreditReg receiveCreditReg = new ReceiveCreditReg();
		receiveCreditReg.setCreateDate(new Date());
		receiveCreditReg.setUpdateDate(new Date());
		model.addAttribute("receiveCreditReg", receiveCreditReg);
	...
	@ResponseBody
	public String update(@Valid @ModelAttribute @RequestBody ReceiveCreditReg receiveCreditReg, Model model)
			throws JsonProcessingException {
		User currentUser = UserUtil.getCurrentUser();
