 ...
 */
@Entity
@Table(name = "LH_RECEIVE_CREDIT_REG")
...
public class ReceiveCreditReg extends BaseEntity implements java.io.Serializable {
	...
	private String creditCompanyView;
	
	@Transient
	public String getCreditCompanyView() {
		creditCompanyView = DictUtils.getCorpName(creditCompany);
		return creditCompanyView;
	}

	public void setCreditCompanyView(String creditCompanyView) {
		this.creditCompanyView = creditCompanyView;
	}
