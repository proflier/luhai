...
import com.cbmie.lh.credit.service.PayRegService;
...
public class PayRegController extends BaseController {
	...
	public Map<String, Object> openCreditList(HttpServletRequest request) {
		...
		payRegService.setCurrentPermission(filters, "LIKES_relLoginNames_OR_createrNo");
	...
	public String createForm(Model model) {
		...
		model.addAttribute("payReg", payReg);
	 ...
	 * 
	 */
	@RequestMapping(value = "toCredit", method = RequestMethod.GET)
	public String toAgencyConfig() {
		return "credit/loadPayApply";
	}
