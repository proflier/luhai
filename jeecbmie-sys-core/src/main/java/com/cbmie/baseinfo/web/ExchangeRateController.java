...
import com.cbmie.baseinfo.service.ExchangeRateService;
...
public class ExchangeRateController extends BaseController{
	...
	@ResponseBody
	public String create(@Valid ExchangeRate exchangeRate, Model model) throws JsonProcessingException {
		if(exchangeRate.getShowTime()==null){
			exchangeRate.setShowTime("");
		}
	...
	@ResponseBody
	public String update(@Valid @ModelAttribute @RequestBody ExchangeRate exchangeRate,Model model) throws JsonProcessingException {
		User currentUser = UserUtil.getCurrentUser();
