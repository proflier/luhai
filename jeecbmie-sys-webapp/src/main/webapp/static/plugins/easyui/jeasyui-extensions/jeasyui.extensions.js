...
(function ($, undefined) {
    ...
    var onLoadError = function (XMLHttpRequest, textStatus, errorThrown) {
        ...
        if(XMLHttpRequest.responseText!=''){
        	parent.$.messager.alert('提示',XMLHttpRequest.responseText,'info');
        }else{
            ...
            var msg = (XMLHttpRequest && !$.string.isNullOrWhiteSpace(XMLHttpRequest.responseText) ?
                    ...
                    "错误号：" + XMLHttpRequest.status + " <hr />" + ((XMLHttpRequest.getResponseHeader("Content-Length")<200)?XMLHttpRequest.responseText : "系统出现内部问题") 
