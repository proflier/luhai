		...
		<div style="float:left;width:100%;">
			<div class="login_main">
				...
				<%-- <div class="login_main_yzm">
					...
					<img alt="验证码" src="${ctx}/static/images/kaptcha.jpg" title="点击更换" id="img_captcha" onclick="javascript:refreshCaptcha();" style="height:35px;width:85px;float:right;margin-right:98px;"/>
					</div>
				</div> --%>
