...
<script type="text/javascript">
	...
	method: "get",
	url:'${ctx}/logistic/railwayContract/jsonNoPermission?filter_NES_changeState=0',
	fit : false,
    singleSelect:false,
	fitColumns : true,
	border : false,
...
function saveRealtion(){
    ...
    $.ajax({
        url: "${ctx}/permission/businessPerssion/saveRealtion4Railway/"+row.loginName,
        type: "GET",
        data: {
            "ids": param,
        },
