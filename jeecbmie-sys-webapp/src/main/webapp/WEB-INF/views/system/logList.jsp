...
<body>
	<div id="tb" style="padding:5px;height:auto">
		<form id="searchFrom" action="">
	        ...
	        <input type="text" name="filter_GTD_createDate" class="easyui-validatebox" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  data-options="width:150,prompt: '操作开始日期'" />
	        - <input type="text" name="filter_LTD_createDate" class="easyui-validatebox" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" data-options="width:150,prompt: '操作结束日期'"/>
